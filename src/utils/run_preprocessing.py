...
from src.utils.modify_folders import sort_folds_by_label, remove_redundant_dirs, make_cnn_structure
...
def run(DIR_PARENT, DIR_DEFECTIVE, DIR_NONDEFECTIVE, DIR_FOLDS):
    ...
    for dir in dirs:
        ...
        create_folds(dir_images=dir_preprocessed, dir_labels=dir_labels, dir_target=dir_target, kfold=KFOLD, n_folds=N_SPLITS)
