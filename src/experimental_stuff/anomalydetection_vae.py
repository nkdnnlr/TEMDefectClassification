...
if preaugmentated:
    train_dir = "../data/cnn_data/non_defective/fold{}/train/nondefective/images".format(0)
    validate_dir = "../data/cnn_data/non_defective/fold{}/test/nondefective/images".format(0)
    test_dir_defective = "../data/cnn_data/defective2/fold{}/train/defective/images".format(str(0))
    test_dir_nondefective = "../data/cnn_data/defective2/fold{}/train/nondefective/images".format(str(0))


assert os.path.exists(train_dir)
assert os.path.exists(validate_dir)
assert os.path.exists(test_dir_defective)
assert os.path.exists(test_dir_nondefective)


print("train_dir=", train_dir)
print("validate_dir=", validate_dir)
print("test_dir_defective=", test_dir_defective)
print("test_dir_defective=", test_dir_nondefective)

if preaugmentated:
    train_generator = preprocess.preprocess_generator(train_dir, batch_size=batch_size)
    validation_generator = preprocess.preprocess_generator(validate_dir, batch_size=batch_size)
    test_defective_generator = preprocess.preprocess_generator(test_dir_defective, batch_size=batch_size)
    test_nondefective_generator = preprocess.preprocess_generator(test_dir_nondefective, batch_size=batch_size)
